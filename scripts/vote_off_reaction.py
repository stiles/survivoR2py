...
csv_output_path = os.path.join(base_dir, "../data/processed/vote_offs/vote_off_log.csv")
json_output_path = os.path.join(base_dir, "../data/processed/vote_offs/vote_off_log.json")
vote_offs_lookup_path = os.path.join(base_dir, "../data/processed/survivor_all_voteoffs.csv")
